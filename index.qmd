...
|:---:|:---|:---:|
| 1 | Introduction to RL | [pending]{.status-cell .pending} |
| 2 | Multi-Armed Bandits | [✓]{.status-cell .done} |
| 3 | Finite Markov Decision Processes | [✓]{.status-cell .done} |
| 4 | Dynamic Programming | [✓]{.status-cell .done} |
| 5 | Monte Carlo Methods | [✓]{.status-cell .done} |
| 6 | Temporal-Difference Learning | [✓]{.status-cell .done} |
| 7 | $n$-step Bootstrapping | [✓]{.status-cell .done} |
| 8 | Planning & Learning with Tabular Methods | [✓]{.status-cell .done} |
| 9 | On-policy Prediction with Approximation | [✓]{.status-cell .done} |
| 10 | On-policy Control with Approximation | [✓]{.status-cell .done} |
| 11 | Off-policy Methods with Approximation | [✓]{.status-cell .done} |
| 12 | Eligibility Traces | [✓]{.status-cell .done} |
| 13 | Policy Gradient Methods | [pending]{.status-cell .pending} |
