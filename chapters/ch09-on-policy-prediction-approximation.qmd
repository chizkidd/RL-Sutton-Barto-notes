...
- ANNs can use TD errors to learn value functions, or they can aim to maximize expected reward as in a gradient bandit ([Section 2.8](ch02-multi-armed-bandits.qmd#sec-ch02-2-8)) or a policy gradient algorithm (Chapter 13).
