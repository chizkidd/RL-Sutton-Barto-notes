...
$$\boxed{Q(S_t, A_t) \leftarrow Q(S_t, A_t) + \alpha\left[R_{t+1} + \gamma \sum_a \pi(a|S_{t+1})\, Q(S_{t+1}, a) - Q(S_t, A_t)\right]}$$
...
$$q(s,a) = 0 \quad \forall s,a \implies \max_{s,a} q(s,a) = 0$$
