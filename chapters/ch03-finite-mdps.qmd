...
## 3.1 The Agent-Environment Interface {#sec-ch03-3-1}

**Agent-Environment loop:**

::: {#fig-31}
![The Agent-Environment Interface](../figures/ch03-3-1-title.png)
...
$$p: S \times S \times A \xrightarrow{[0,1]} \quad p(s'|s,a) \doteq \mathbb{P}\{S_t = s' \mid S_{t-1} = s,\, A_{t-1} = a\} = \sum_{r \in R} p(s', r | s, a)$$
...
## 3.4 Unified Notation for Episodic & Continuing Tasks {#sec-ch03-3-4}

**Episode diagram:**

::: {#fig-34}
![state transition diagram](../figures/ch03-3-4.png)

State transition diagram
:::

$$S_0 \xrightarrow{R_2=+1} S_1 \xrightarrow{R_2=+1} S_2 \xrightarrow{R_3=+1} \square \quad \begin{cases} R_4 = 0 \\ R_5 = 0 \\ \vdots \end{cases}$$
...
## 3.5 Policies & Value Functions {#sec-ch03-3-5}
...
::: {#fig-35}
![v_pi Backup Diagram](../figures/ch03-3-5-v-pi.png))

Backup Diagram for $v_\pi$
:::

> **Backup diagram for $v_\pi$**: open circle = state $s$, filled circles = state-action pairs, open squares = successor states $s'$.

---

## 3.6 Optimal Policies & Optimal Value Functions {#sec-ch03-3-6}
...
::: {#fig-36}
![v* and q* Backup Diagram](../figures/ch03-3-6-v-q-optimal.png))
...
## 3.7 Optimality & Approximation {#sec-ch03-3-7}
...
- **Policy**: a stochastic rule by which the agent selects actions as a function of states: $\pi(a|s) = \mathbb{P}[A_t = a | S_t = s]$
