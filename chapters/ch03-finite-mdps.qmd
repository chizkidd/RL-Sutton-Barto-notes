...
$$\boxed{p(s', r \mid s, a) \doteq \mathbb{P}\{S_t = s',\, R_t = r \mid S_{t-1} = s,\, A_{t-1} = a\} \quad \forall\, s', s \in \mathcal{S},\, r \in \mathbb{R},\, a \in \mathcal{A}(s)}$$
...
| State-transition <br>probability matrix:<br>$P_{ss'} = \mathbb{P}[S_{t+1} = s' \mid S_t = s]$ | Sequences of <br>random states $(S_1, S_2, \ldots)$ + <br>Markov property | Markov Chain with Values | MRP + decisions |
