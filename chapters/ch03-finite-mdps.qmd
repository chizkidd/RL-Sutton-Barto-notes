...
- To build the full RL problem mathematical structure, key elements are introduced: **returns, value functions, & Bellman equations.$$
...
- The agent and environment interact continually over a sequence of discrete time steps.
