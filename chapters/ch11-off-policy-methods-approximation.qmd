...
- How can we alleviate the effects of high variance via small step-size settings that are enough to ensure the expected step taken by SGD is small? Some approaches:
  - Momentum
