...
## 11.1 Semi-gradient Methods {#sec-ch11-11-1}
...
- In the multi-step generalizations of the algorithms, both the state-value and action-value algorithms involve importance sampling. For example, the $n$-step off-policy, semi-gradient $\mathbf{n}$**-step Sarsa** update is:
...
- The off-policy, semi-gradient **$n$-step backup tree** (no importance sampling) algorithm is:
...
## 11.2 Examples of Off-Policy Divergence {#sec-ch11-11-2}
...
::: {#fig-111}
![](../figures/ch11-11-2-example1.png){fig-align="center"} 
...
::: {#fig-112}
![](../figures/ch11-11-2-bairds-counterexample.png){fig-align="center"} 
...
::: {#fig-113}
![](../figures/ch11-11-2-tsitsiklis-van-roy-counterexample.png){fig-align="center"} 

Tsitsiklis & Van Roy's Counterexample.
:::
...
## 11.3 The Deadly Triad {#sec-ch11-11-3}
...
## 11.4 Linear Value-Function Geometry {#sec-ch11-11-4}
...
::: {#fig-113}
![](../figures/ch11-11-4-linear-value-func-approx-geometry.png){fig-align="center"} 
...
## 11.5 Gradient Descent in the Bellman Error {#sec-ch11-11-5}
...
## 11.6 The Bellman Error is Not Learnable {#sec-ch11-11-6}
...
::: {#fig-114}
![](../figures/ch11-11-6-example1.png){fig-align="center"} 

Value Error (VE) Learnability Counterexample
:::
...
::: {#fig-115}
![](../figures/ch11-11-6-example2.png){fig-align="center"} 

Bellman Error (BE) Learnability Counterexample
:::
...
::: {#fig-116}
![](../figures/ch11-11-6-causal-relationships-mdps-datadistr-errors.png){fig-align="center"} 
...
## 11.7 Gradient-TD Methods {#sec-ch11-11-7}
...
## 11.8 Emphatic-TD Methods {#sec-ch11-11-8}
...
## 11.9 Reducing Variance {#sec-ch11-11-9}
