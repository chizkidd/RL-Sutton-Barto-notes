...
::: {.callout-note tip="Multi-Armed Bandit"}
In my understanding, a multi-armed bandit is a tuple $\tuple{A, R}$ 
where $A$ is a known set of $m$ actions or **"arms"** and 
$R^a_(r)$ is an unknown probability distribution over rewards
:::
---
...
::: {.callout-note tip="Optimistic Initialization"}
_**Assume the best action-value, until proven otherwise.**_<br><br>
I think that basically **optmistic init.** encourages _systematic exploration 
early on but can still lock onto suboptimal action._
:::
