...
- **$\varepsilon$-greedy method** $\Rightarrow$ simplest idea for ensuring continual exploration. With $m$ total actions:
...
### Proof: The Bandit Gradient Algorithm as Stochastic Gradient Ascent {#sec-ch02-2-8}
