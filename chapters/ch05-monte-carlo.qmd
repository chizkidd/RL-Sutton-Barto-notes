...
$$\pi(a \vert s) = \begin{array}{ll} 1 - \varepsilon + \dfrac{\varepsilon}{\vert A(s) \vert} & \text{if greedy action} \\[6pt] \dfrac{\varepsilon}{\vert A(s) \vert} & \text{if non-greedy action} \end{array}$$
...
$$\begin{aligned}
\text{where } p &\equiv p(s', r \vert s, a) = \text{state-transition probability function}
\end{aligned}$$
